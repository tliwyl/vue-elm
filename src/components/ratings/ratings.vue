  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <ratingselect :selectType="selectType" :onlyContent="onlyContent" :ratings="ratings"
                    @updateSelectType="updateSelectType" @updateOnlyContent="updateOnlyContent"></ratingselect>
      <div class="rating-wrapper">
        <ul>
          <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in ratings"
              class="rating-item border-px-scale">
            <div class="avatar"><img :src="rating.avatar" width="28" height="28" alt=""></div>
            <div class="content">
              <h1 class="name">{{rating.username}}</h1>
              <div class="star-wrapper">
                <star :size="24" :scrore="rating.score"></star>
